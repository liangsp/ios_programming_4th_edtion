...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([segue.identifier isEqualToString:@"NewColor"])
    {
        ...
        BNRColorViewController *cc = (BNRColorViewController *)[nc topViewController];
        
        cc.colorDescription = color;
    }
    else if ([segue.identifier isEqualToString:@"ExistingColor"])
    {
        ...
        BNRColorViewController *cc = (BNRColorViewController *)segue.destinationViewController;
        
        cc.colorDescription = color;
        cc.existingColor = YES;
    }
